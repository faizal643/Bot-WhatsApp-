// =============================================
// VERSION UPDATE
// UPDATE TERAKHIR 19 Juni 2024 JAM 00:00 WIB
// WEBSITE : autoresbot.com
// VERSION : 3.1
// =============================================


const fs=require("fs"),chalk=require("chalk"),moment=require("moment-timezone");
...
global.mess  = {
    ...
    response_failed : '_🚫 *Response Ke Server Gagal Coba Ketik .updatebot untuk memperbaiki masalah*_\n\n_Apabila Butuh Bantuan Silakan Hubungi_\nhttps://t.me/autoresbot_com',
    ...
    antispam1        : '_Peringatan: Jangan mengirim chat spam. Anda akan di kick dari grup jika melanjutkan spam._',
...
let file=require.resolve(__filename);fs.watchFile(file,(()=>{fs.unwatchFile(file),console.log(`${chalk.greenBright.bold(`UPDATE FILE ${__filename}`)}`),delete require.cache[file],require(file)}));